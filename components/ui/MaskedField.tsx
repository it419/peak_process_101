...
/** A text field that masks its value to the last 4 characters once complete and blurred, with a reveal toggle. */
            ...
            <div className="relative">
              ...
              {isComplete && (
                <button
                  ...
                  tabIndex={-1}
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 text-paper-ink-400 transition-colors hover:text-paper-ink-600"
